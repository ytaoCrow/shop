...
public class ProductDaoImpl implements ProductDao {
    ...
    @Override
    public Integer countProduct(ProductsQueryParams productsQueryParams) {
        String sql ="SELECT count(*) FROM product WHERE 1=1";

        Map<String, Object>map = new HashMap<>();

        //查詢條件
        sql = addFilteringSql(sql, map, productsQueryParams);
    ...
    public List<Product> getProducts(ProductsQueryParams productsQueryParams) {
        ...
        //排序
        sql = sql + " ORDER BY " + productsQueryParams.getOrderBy() + " " + productsQueryParams.getSort();

        //分頁
        sql = sql + " LIMIT :limit OFFSET :offset";
        map.put("limit", productsQueryParams.getLimit());
        map.put("offset", productsQueryParams.getOffset());
    ...
    private  String addFilteringSql(String sql, Map<String, Object> map, ProductsQueryParams productsQueryParams){
